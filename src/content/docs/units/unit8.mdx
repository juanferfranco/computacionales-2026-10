...
:::note[Transparencia]
En esta unidad se mantiene el trabajo por fases (set, seek y apply) como ruta
pedagógica, pero la **única evaluación calificable** es la **sustentación
final** al cierre de la Actividad 05.
:::

### Condiciones para presentar la sustentación

:::caution[Requisito de entrada a la evaluación]
Para poder presentar la sustentación debes completar las actividades 1 a 5. La 
actividad 6 la realizarás una vez presentes la sustentación. Recuerda que el 
propósito de la actividad 6 es la consolidación del aprendizaje mediante un 
ejercicio de práctica de recuperación (retrieval practice).
:::

:::tip[Nota de la unidad]
Será la califación que obtengas en la sustentación
:::
...
:::note[🎯 Enunciado]
Es hora de aplicar lo aprendido sobre paralelismo. Tomarás el código funcional del fractal de Mandelbrot que estudiante (¿Cierto?) y lo modificarás para 
calcular y visualizar el **conjunto de Julia**. Harás que la constante `k` que define el fractal de Julia dependa de la posición del mouse, creando un 
explorador interactivo. El cálculo seguirá siendo paralelo.
:::
...
:::caution[📤 Bitácora]
Documenta todos tu proceso en la bitácora de aprendizaje y analiza la implementación. 
Te recomiendo que uses IA para que te ayude a autoevaluar los conceptos aplicados.
:::
...
Esta sección se realiza después de cerrada la sustentación como un ejercicio de consolidación.
:::
