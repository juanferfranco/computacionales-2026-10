...
evaluación**. La evaluación se centra en la calidad de las evidencias y en tu
capacidad para explicar con responsabilidad qué ocurre en tu programa cuando
hay múltiples hilos, datos compartidos y decisiones de sincronización.
:::
