...
2. **USA EL DEPURADOR:** 
    * Captura pantallas y luego explica inmediatamente lo que observas y 
    analizas para evidenciar cada uno de los errores que identificaste.

3. **Induce los fallos:**
    * Trata de quebrar el programa de manera controlada para evidenciar los errores. 
    No olvides capturas de pantalla del DEPURADOR para evidenciar lo que ocurre en memoria.
